...
void EFPoint::serialize(Archive &ar, const unsigned int version)
{
    ar & EFPoint::priorF & EFPoint::deltaF;
    ar & EFPoint::bdSumF & EFPoint::HdiF;
    ar & EFPoint::Hdd_accLF & EFPoint::bd_accLF & EFPoint::Hdd_accAF& EFPoint::bd_accAF;

}
template void EFPoint::serialize(boost::archive::binary_iarchive&, const unsigned int);
template void EFPoint::serialize(boost::archive::binary_oarchive&, const unsigned int);
