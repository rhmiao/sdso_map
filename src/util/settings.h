...
extern int featuresLvl;
extern std::string settingFile;
extern std::string platformFile;
extern std::string stereo_param_file;
extern std::string loadMapPath;
extern std::string saveMapPath;
extern std::string vocPath;
extern float scale_XI_stereo;
extern float scale_idepth_stereo;
extern float max_speed;
extern int setting_recordKeyframesInLocalMap;
extern int setting_panoramaTracker;
...
extern float stereo_optimize_lamda;
