...
int featuresLvl = pyrLevelsUsed-3;
std::string settingFile = "/home/mrh/catkin_ws/src/cgdso/config/setting.xml";
std::string stereo_param_file = "/home/mrh/catkin_ws/src/cgdso/config/zed_calib.xml";
std::string platformFile="/home/mrh/catkin_ws/src/cgdso/config/kitti_setting.xml";
std::string loadMapPath="";
std::string saveMapPath="";
std::string vocPath="";
float scale_XI_stereo=1.0f;
float scale_idepth_stereo=1.0f;
float max_speed=10;
float stereo_optimize_lamda=8;
int setting_recordKeyframesInLocalMap=5;
int setting_panoramaTracker=1;
...
float setting_maxShiftWeightT= 0;//0.04f * (640+480);
float setting_maxShiftWeightR= 0;//0.0f * (640+480);corasetracker
float setting_maxShiftWeightRT= 0;//0.02f * (640+480);
...
float setting_minPointsRemaining = 0.2;  // marg a frame if less than X% points remain.
