...
namespace dso
{
    ...
    float bfG[PYR_LEVELS];
    float ibfG[PYR_LEVELS];
    Vec3f KtStereoG[PYR_LEVELS];
    ...
    Mat33f STEREO_PRE_RTll;
    Mat33f STEREO_PRE_KRKiTll;
    Mat33f STEREO_PRE_RKiTll;

    Vec3f STEREO_PRE_tTll;
    Vec3f STEREO_PRE_KtTll;
    float STEREO_distanceLL;
