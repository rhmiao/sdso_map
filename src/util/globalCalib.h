...
namespace dso
{
    ...
    extern float bfG[PYR_LEVELS];
    extern float ibfG[PYR_LEVELS];
    extern Vec3f KtStereoG[PYR_LEVELS];

	extern float wM3G;
	extern float hM3G;

    //stereo precalc values
    extern Mat33f STEREO_PRE_RTll;
    extern Mat33f STEREO_PRE_KRKiTll;
    extern Mat33f STEREO_PRE_RKiTll;

    extern Vec3f STEREO_PRE_tTll;
    extern Vec3f STEREO_PRE_KtTll;
    extern float STEREO_distanceLL;
