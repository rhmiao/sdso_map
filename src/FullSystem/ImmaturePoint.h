...
public:
    ...
    ImmaturePointStatus traceOnRotation(FrameHessian* frame,const Mat33f &hostToFrame_KRKi, const Vec3f &hostToFrame_Kt, const Vec2f& hostToFrame_affine, CalibHessian* HCalib, bool debugPrint);
    ImmaturePointStatus traceOnRight(FrameHessian* frame,CalibHessian* HCalib, bool debugPrint);
    ImmaturePointStatus traceStereo(Eigen::Vector3f* dI[],int level);
