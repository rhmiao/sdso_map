...
//        printf("frame %d, as only %'d/%'d points remaining (%'d %'d %'d %'d). \n",
//                i, in, in+out,
...
//        if(fh==frame){
//            for(ImmaturePoint* ph : fh->immaturePoints)std::cout<<fh->idx<<" "<<ph->obCount<<std::endl;
//            continue;
//        }
    ...
    deleteOutOrder<FrameHessian>(frameHessians, frame,frame->isRecord);
