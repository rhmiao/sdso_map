...
public:
    ...
    PangolinDSOViewer(int w, int h,std::string windowName="Main", bool startRunThread=true);
    ...
    virtual void publishRecordKeyframes(std::vector<std::vector<FrameHessian*>> &frames,FrameHessian* currentFrame, bool final, CalibHessian* HCalib);
